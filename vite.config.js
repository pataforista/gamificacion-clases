  ...
  plugins: [
    ...
    VitePWA({
      ...
      workbox: {
        ...
        // locales, los avatares de personajes y la fuente auto-hospedada para
        // que TODO funcione offline desde la primera carga (no queda ningún
        // recurso externo: los SFX de mixkit fueron reemplazados por los
        // generados con scripts/generate-sounds.mjs y la fuente Outfit viene
        // de @fontsource-variable/outfit).
        globPatterns: ['**/*.{js,css,html,ico,png,svg,webmanifest,mp3,woff2}'],
